...
import { View , Text, Button , Image , NetInfo,Alert ,  TouchableOpacity , StyleSheet , Share , ActivityIndicator , Platform,ImageBackground} from 'react-native';
...
export default class trafficupdate extends React.Component {
           ...
           <ImageBackground source={require('./../../src/images/header_160.png')} style={{width:'100%' , height:60 , justifyContent:'center'}}>
                              ...
                              <View style={{height:100  ,flex:1 , flexDirection:'row' , justifyContent:'space-between' , marginTop:5}}>
                                          ...
                                          <TouchableOpacity onPress={() =>this.props.navigation.goBack()}>
                                            ...
                                            <Text style={{fontSize:20, marginTop:5  , color:'white'}}>Traffic Update</Text>
